      ...
      <div className="gender-ratio-outer">
        <div className="gender-ratio-inner">
          ...
          <div className="gender-ratio-row">
            ...
            <p>
              CIT Kokrajhar admitted batch of B.Tech. with an intake of 350 students for both 
              final and pre-final year in 6 various branches of engineering (CSE, ECE, IE, CE, FET and MCD).
            </p>
          </div>
        </div>
      </div>
