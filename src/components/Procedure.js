  ...
  <div className="procedure-outer">
    ...
    <div className="procedure-wrapper">
      <h2 className="special">Placement Procedure</h2>
        <ul className="custom-list">
        <li>
          Organization fills the Placement Form containing details of the job offer (pay
          package, place of posting, allowances and other bonuses). Organizations can also
          directly sent the proposal to Training and Placement Cell, CITK (
          <a href="mailto:tnpcell@cit.ac.in">tnpcell@cit.ac.in</a>).
        </li>
        <li>
          The organization details along with job offer is made available to the
          students on a private group, requesting them to apply.
        </li>
        <li>
          Training and Placement Cell, CITK allots date(s) to an organization
        ...
        <li>
          ...
          candidates at the end of assigned interview slot, preferably on the
          day of campus visit.
        </li>
        <li>
      ...
      <div className="sub-part">
        ...
        <p>
          ...
          summer internship. The student will join the company during the summer / winter
          brakes as an intern for a period of 2 months.
        </p>
        <p>
      ...
      <div className="placement-policy-heading">
        ...
        <ul className="custom-list">
          <li>All full time final year students (B.Tech, M.Tech and Ph.D.) of CIT Kokrajhar 
              are eligible to participate in the recruitment process for placements through 
              the Training and Placement (T&P) Cell except those Ph.D. students who have not 
              submitted their synopsis. 
          </li>
          <li>Students carrying specific course backlog(s) may or may not be allowed to appear 
            in the recruitment process as per the eligibility criteria of the concerned company/
            organization.
          </li>
          <li>
            All students eligible for on-campus jobs have to submit their details online to the 
            T&P Cell. Only after the successfull submission, their resume and other
            details will be sent to the hiring organization.
          </li>
        </ul>
        <h2 className="ph-subheading">Student Conduct and Disciplinary Policy</h2>
        <ul className="custom-list">
          <li>Absenteeism policy:
              In case a student remains absent from the recruitment process of a company
              for which he/she has confirmed his/her participation through his/her T&P 
              student account, strict disciplinary action will be taken against the student.
          </li>
          <li>Using unfairmeans during any round of the recruitment process is a serious offence. 
            Such students would be deregistered immediately and also will be referred to the 
            concerned authorities for disciplinary action.
          </li>
        </ul>
